...
class ContactForm {
    ...
    public function validate(): bool {
        ...
        if (empty($this->surname)) {
            $this->errors['surname'] = 'Le prénom est obligatoire.';
        }
        ...
        if (empty($this->object)) {
            $this->errors['object'] = 'L’objet est obligatoire.';
        }
    ...
    public function getObject(): string {
        return htmlspecialchars($this->object);
    }
